...
function HomeHero() {
  ...
  return (
    <>
      ...
      <div className='h-[45px] content-center md:block hidden'>
...
{/* mobile screen  */}
      <div ref={wrapperRef} className="wrapper w-full flex items-center overflow-hidden justify-center py-2 border bg-whiteColor z-20 md:hidden">
