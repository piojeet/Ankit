        ...
        <>
            <div className='grid lg:grid-cols-2 grid-cols-1 px-2 gap-2'>
                <div>
                    ...
                    <div className='bg-[#E6FCDA] py-4 md:py-0 border border-green-500 rounded-md'>
                        <div className='flex bg-[#E6FCDA] items-center justify-center md:h-[20vh] rounded-md'>
                            <div className='h-full w-full content-center px-2'>
                                <img src={Logo} alt="" className='md:w-[90%] w-[80%] block mx-auto' />
                            </div>
                            <span className='md:inline-block w-[2px] h-[20vh] bg-[#23262f00] border-r-2 border-[#23262F52] border-dotted hidden'></span>
                            <div className=' w-[90%] px-2 md:block hidden'>
                                <div className='block w-fit mx-auto'>
                                    <span className='text-blackColor font-bold text-[10px] md:text-[12px]'>join now for cashback, coupon and price drop alerts</span>
                            ...
                            <div className='w-full'>
                                <div className='flex items-center justify-center px-2 gap-2'>
                                    ...
                                    <div className='flex flex-col items-center justify-center'>
                                        ...
                                        <span className='text-[13px] text-blackColor font-medium'>Whatsapp</span>
                                    </div>
                                    <div className='flex flex-col items-center justify-center'>
                                        <span className='flex-shrink-0'><img src={Telegram} alt="" className='md:w-14 w-[35px] h-[35px]' /></span>
                                        <span className='text-[13px] text-blackColor font-medium'>Telegram</span>
                                    </div>
                                </div>
                            </div>

                        </div>
                        <div className='block w-fit mx-auto md:hidden py-2'>
                            <span className='text-blackColor font-bold text-[10px] md:text-[12px]'>join now for cashback, coupon and price drop alerts</span>
                        </div>
                    </div>
